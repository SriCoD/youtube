...
//         <div>
//         <input
//           className="w-1/2 text-black border border-gray-400 p-2 rounded-l-full"
//           type="text"
//           value={searchQuery}
...
//         />
//         <button className="border border-gray rounded-r-full px-3  py-2">
//           Search
//         </button>
//         </div>
//         {showSuggestions && (<div className="fixed shdow-lg rounded-corner border border-gray-100 bg-white py-2 px-5 w-[37rem]">
